...
sed -e 's!^metalink=!#metalink=!g' -e 's!^#baseurl=!baseurl=!g' -e 's!//download\.fedoraproject\.org/pub!//mirrors.ustc.edu.cn!g' -i /etc/yum.repos.d/epel.repo /etc/yum.repos.d/epel-testing.repo
```
### 网络
```bash
# 关闭firewalld
